...
bool xversion_deterministic_hashing = true;

XMapSaltedHasher::XMapSaltedHasher()
    : k0(xversion_deterministic_hashing ? 0x1122334455667788UL : 0),
      k1(xversion_deterministic_hashing ? 0x99aabbccddeeff00UL : 0)
{
}
